...
```
 python -m src.cli.estimate_one --image dataset\test_01\Basler_acA2040-35gm__23324651__20250826_151237703_0000.tiff --camera config/calib_data.npz --aruco_dict 4X4_50 --marker_size 0.053 --cube_size 0.063 --pair_strategy first --out overlay.png --show
```
