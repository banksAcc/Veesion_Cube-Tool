...
def build_cube_id_to_obj(edge_mm=61.0, marker_mm=53.0, id_order=None):
    ...
    # Definiamo le trasformazioni per ogni faccia usando una convenzione standard:
    # +X: destra, +Y: alto, +Z: fronte
    faces = {
